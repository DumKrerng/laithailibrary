 ...
 */
public class DataFieldDocumentUSERID extends DataField<DBString> {

	private static final long serialVersionUID = 6541383258745821453L;

	public DataFieldDocumentUSERID() {}

	public DataFieldDocumentUSERID(TableName p_tablename, String p_strFieldName) {
